...
const Contact = ({ sell }) => {
    ...
    try {
      ...
      if (result.status === "success") {
        setMessageInfo({
          type: "success",
          text: sell
            ? "Thank you for your interest in joining Artisbay! We will review your application and get back to you within a few days."
  ...
  return (
    <div className="form-wrapper contact-wrapper">
      <div
        className={`signup-container contact-container ${
      ...
      >
        <form className="signup-form contact-form" onSubmit={handleSubmit}>
          ...
          >
            ...
            offerings, please don't hesitate to reach out using the form below.
            We're always eager to connect with our customers and will respond as
          ...
          {messageInfo && (
            <div
              className={`message ${
                messageInfo.type === "success" ? "success" : "error"
              }`}
            >
              {messageInfo.text}
            </div>

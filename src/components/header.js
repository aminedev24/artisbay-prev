    ...
    <div className="header-container">
      ...
      <header className="main-header">
        <div className="header-top">
          ...
          <div className={`header-icons ${isMobileMenuOpen ? "show" : ""}`}>
        ...
        <div className={`header-bottom ${isMobileMenuOpen ? "show" : ""}`}>
          ...
          <div className="right-links">
            ...
            >
              ...
              >
                ...
                <Link to={"/help?topic=Company%20Profile"}>
                  Company Profile
                </Link>
                <Link to={"/help?topic=Bank%20Information"}>
                  Bank Information
                </Link>

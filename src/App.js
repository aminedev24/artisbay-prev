    ...
    <UserProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/stocklist"
            element={<Stocklist cars={cars} filters={filters} />}
          />{" "}
          {/* Pass filters to Stocklist */}
          ...
          <Route
            path="/local-services/namibia"
            element={<NamibiaAgent />}
          ></Route>
          <Route path="/local-services/congo" element={<CongoAgent />}></Route>
          <Route
            path="/local-services/tanzania"
            element={<TanzainaAgent />}
          ></Route>
        </Routes>
        <Footer />
      </Router>
